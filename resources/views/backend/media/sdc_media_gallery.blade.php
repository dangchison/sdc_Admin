                ...
                <div class="panel-body">
                    ...
                    <div id="gallery" class="media-gal">
                        ...
                        <div class=" audio item " >
                            <a href="#myModal" data-toggle="modal">
                                <img src={{ asset("images/gallery/image2.jpg") }} alt="" />
                            </a>
                            <p>img02.jpg </p>
                        </div>
                        <div class=" video item " >
                            <a href="#myModal" data-toggle="modal">
                                <img src={{ asset("images/gallery/image3.jpg") }} alt="" />
                            </a>
                            <p>img03.jpg </p>
                        </div>
                        <div class=" images audio item " >
                            <a href="#myModal" data-toggle="modal">
                                <img src={{ asset("images/gallery/image4.jpg") }} alt="" />
                            </a>
                            <p>img04.jpg </p>
                        </div>
                        <div class=" images documents item " >
                            <a href="#myModal" data-toggle="modal">
                                <img src={{ asset("images/gallery/image5.jpg") }} alt="" />
                            </a>
                            <p>img05.jpg </p>
                        </div>
                        <div class=" audio item " >
                                ...
                                <div class="modal-body row">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="link" value={{ asset("images/gallery/image1.jpg") }} class="form-control">
                                        </div>
