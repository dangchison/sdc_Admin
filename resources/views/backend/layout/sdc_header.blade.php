        ...
        <ul class="notification-menu">
            ...
            <li>
                ...
                <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                    <li><a href={{ URL::route("B.user.profile") . "?slug=" . Auth::user()->user_slug }}><i class="fa fa-user"></i>  Profile</a></li>
                    <li><a href={{ URL::route("B.post.logout") }}><i class="fa fa-sign-out"></i> Log Out</a></li>
                </ul>
            </li>
